...
const AttendanceUpdate = () => {
  ...
  return (
    <div className="space-y-8 pb-12 animate-in fade-in duration-700">
      {/* Header & Context */}
      <div className="bg-white rounded-[2.5rem] p-8 sm:p-10 shadow-sm border border-primary/10 flex flex-col gap-8 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
          <div className="flex items-center gap-6">
            <button
              onClick={() => navigate(-1)}
              className="w-12 h-12 rounded-2xl bg-primary/5 flex items-center justify-center text-slate-400 hover:bg-primary/10 transition-all active:scale-95"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="bg-blue-50 px-5 py-3 rounded-2xl flex flex-col items-center border border-blue-100/50">
            ...
            <div className="bg-rose-50 px-5 py-3 rounded-2xl flex flex-col items-center border border-rose-100/50">
            ...
            <button
              ...
              className="ml-2 px-8 py-4 bg-primary text-white font-black text-xs uppercase tracking-widest rounded-2xl shadow-xl shadow-primary/20 hover:bg-primary/90 transition-all flex items-center gap-3 active:scale-95 disabled:opacity-50"
            >
        ...
        {/* Controls Row */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10 pt-4 border-t border-primary/10">
            ...
            <div className="relative">
              ...
              {isHoliday && (
                <div className="absolute -bottom-6 left-1 flex items-center gap-1.5 text-[10px] font-bold text-rose-500 uppercase tracking-wide">
                  <AlertCircle className="w-3 h-3" /> Holiday: No session today
                </div>
              )}
            </div>
          </div>
          ...
          <div className="flex items-end gap-6">
            <div className="flex items-center gap-3 bg-primary/5 px-6 py-3.5 rounded-2xl border border-primary/10 w-full">
              <input
                type="checkbox"
                id="allPresent"
                checked={allPresent}
              ...
              <label
                htmlFor="allPresent"
                className="text-[10px] font-black text-slate-600 uppercase tracking-widest cursor-pointer select-none"
              >
                Mark All Present
              </label>
            </div>
          ...
          <div className="flex items-end">
            <div className="relative group w-full">
              ...
              <input
                ...
                className="w-full pl-14 pr-6 py-3.5 bg-primary/5 border border-primary/10 rounded-[1.5rem] text-xs font-bold text-slate-600 focus:ring-4 focus:ring-primary/10 focus:border-primary/50 outline-none transition-all"
              />
            </div>
          </div>
        </div>
          ...
          {filteredStudents.map((student) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative p-6 rounded-[2rem] border-2 transition-all duration-300 group overflow-hidden flex flex-col items-center text-center gap-4 active:scale-95 shadow-sm",
                  status === 1 &&
              ...
              >
                ...
                <div className="absolute top-4 right-4 transition-transform group-hover:scale-125">
                  {status === 1 && (
                  ...
                  {status === 2 && (
                    <CalendarCheck2 className="w-5 h-5 text-white/40" />
                  )}
                </div>

                <div
                  className={cn(
                    "w-20 h-20 rounded-[1.5rem] border-4 p-1 shadow-xl transition-all duration-300",
                ...
                <div className="space-y-1">
                  <p
                    className={cn(
                      "text-xs font-black uppercase tracking-tight line-clamp-1 px-2",
                ...
                <div
                  className={cn(
                    "absolute bottom-0 inset-x-0 py-1 transition-all",
                    status ? "bg-white/10" : "bg-primary/5",
                  )}
                >
