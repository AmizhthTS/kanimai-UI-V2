...
const BoardingPointMaster = () => {
  ...
  const fetchBoardingPoints = async () => {
    ...
    try {
      ...
      setBoardingPoints(response.data.responseModelList || []);
      setTotalCount(response.data.count || 0);
    } catch (error) {
      console.error("Error fetching boarding points:", error);
      toast.error("Failed to load boarding point list");
    } finally {
  ...
  const onFormSubmit = async (data: any) => {
    ...
    try {
      ...
      toast.error("Failed to save boarding point");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      toast.error("Failed to delete boarding point");
    }
  };
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-black text-slate-800 tracking-tight">
              Boarding Point <span className="text-primary">Details</span>
            </h1>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            >
              <TextInput
                ...
                placeholderName="Boarding Point Name"
                requiredMsg="Boarding Point Name is required"
                labelMandatory
              />
...
export default BoardingPointMaster;
