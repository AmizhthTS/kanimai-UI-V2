  ...
  return (
    <div className="space-y-6 pb-10 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        >
          <TabsList className="bg-white border border-slate-100 p-1 rounded-xl h-auto w-full flex overflow-x-auto scrollbar-none whitespace-nowrap">
            <TabsTrigger
              value="college"
              className="px-4 py-2 text-[8px] md:text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-white rounded-lg flex items-center gap-2 whitespace-nowrap flex-shrink-0"
            >
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              onClick={() =>
                                navigate(
                                  `/admin/master/event/edit/${event.id}`,
                                  {
                                    state: { type: activeTab },
                                  },
                                )
                      ...
                      <div className="space-y-3 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[10px] font-black px-2 py-0.5 bg-slate-100 text-slate-600 rounded-md uppercase tracking-wider">
                            {event.noOfDays}{" "}
                            {event.noOfDays === 1 ? "Day" : "Days"}
                          </span>

                          {activeTab === "course" && event.courseName && (
                            <span className="text-[10px] font-black px-2 py-0.5 bg-primary/5 text-primary rounded-md uppercase tracking-wider">
                              {event.courseName}
                            </span>
                          )}
                        </div>
            ...
            <div className="flex items-center justify-center px-6 py-20">
              <div className="flex flex-col items-center gap-3 text-center">
                <div className="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center">
                  <Calendar className="w-8 h-8 opacity-20 text-slate-400" />
                </div>
