...
const DayOrderMaster = () => {
  ...
  const fetchDayOrders = async () => {
    ...
    try {
      ...
      toast.error("Failed to load day order list");
    } finally {
  ...
  const onFormSubmit = async (data: any) => {
    ...
    try {
      ...
      toast.error("Failed to save day order");
    } finally {
      setLoading(false);
    }
  };

  const handleEdit = (dayOrder: any) => {
    reset({
      id: dayOrder.id,
      orderName: dayOrder.orderName,
    });
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      toast.success("Day Order deleted successfully");
      fetchDayOrders();
    } catch (error) {
      console.error("Error deleting day order:", error);
      toast.error("Failed to delete day order");
    }
  };
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-black text-slate-800 tracking-tight">
              Day Order <span className="text-primary">Details</span>
            </h1>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <form onSubmit={handleSubmit(onFormSubmit)} className="p-6 space-y-5">
              <TextInput
                ...
                errors={errors}
                name="orderName"
                textLable="Day Order Name"
                placeholderName="Enter Day Order Name"
                requiredMsg="Day Order Name is required"
                labelMandatory
              />
                ...
                <tbody className="divide-y divide-slate-50">
                  {listLoading ? (
                    ...
                    <tr>
                      ...
                      >
                        No day orders found matching your search.
                      </td>
                    </tr>
                  )}
                </tbody>
