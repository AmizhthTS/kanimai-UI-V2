...
const SubjectMaster = () => {
  ...
  const onFormSubmit = async (data: any) => {
    setLoading(true);
    try {
      await masterApi.saveSubject(data);
      toast.success(
        data.id ? "Subject updated successfully" : "Subject saved successfully",
      );
      reset({ id: "", subjectName: "", subjectCode: "", courseDuration: "" });
      fetchSubjects();
    } catch (error) {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-black text-slate-800 tracking-tight">
              Subject <span className="text-primary">Details</span>
            </h1>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div className="bg-slate-50/50 px-6 py-4 border-b border-slate-100">
              <h3 className="font-bold text-slate-800 flex items-center gap-2 text-sm">
                ...
                {control._formValues.id ? "Update Subject" : "Add New Subject"}
              </h3>
            </div>
            ...
            >
              <TextInput
                ...
                errors={errors}
                name="subjectName"
                textLable="Subject Name"
                placeholderName="Enter Subject Name"
                requiredMsg="Subject Name is required"
                labelMandatory
              />
              ...
              <TextInput
                ...
                errors={errors}
                name="subjectCode"
                textLable="Subject Code"
                placeholderName="Enter Subject Code"
                requiredMsg="Subject Code is required"
                labelMandatory
              />
              ...
              <TextInput
                ...
                name="courseDuration"
                type="number"
                textLable="Total Hours"
                placeholderName="Enter Total Hours"
                requiredMsg="Total Hours are required"
                labelMandatory
              />
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                >
                  ...
                  {control._formValues.id ? "UPDATE SUBJECT" : "SAVE SUBJECT"}
                </button>
                <button
                  type="button"
                  onClick={() =>
