  ...
  return (
    <div className="space-y-6 pb-10 animate-in fade-in duration-700">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 flex flex-col overflow-hidden">
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <button
                        ...
                        className="px-3 py-1 rounded-full bg-blue-50 text-blue-500 text-xs font-bold hover:bg-blue-100 transition-colors cursor-pointer"
                      >
        ...
        <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-end bg-white min-h-[60px]">
          {totalCount > 1 && (
            <CustomPagination
