      ...
      <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-slate-500">View your monthly attendance details</p>
          </div>
        </div>
        
        <div className="flex items-center justify-center h-64 bg-slate-50 rounded-2xl border border-slate-100 border-dashed">
           <p className="text-slate-400 font-bold">Attendance details will be displayed here.</p>
        </div>
      </div>
    </div>
  );
