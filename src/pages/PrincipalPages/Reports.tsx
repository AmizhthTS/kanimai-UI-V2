...
const PrincipalReports = () => {
  const [reportType, setReportType] = useState("FACULTY_ATTENDANCE");
  const [downloading, setDownloading] = useState(false);

  const reportsList = [
    { id: "FACULTY_ATTENDANCE", name: "Faculty Attendance Summary Report", desc: "Aggregated present, absent, late entry and OD analytics of all faculty members." },
    { id: "DEPT_COMPARISON", name: "Department Performance Comparison", desc: "Comparative analysis of departmental GPA, average attendance, and academic achievements." },
    { id: "STUDENT_PERFORMANCE", name: "Institution-wide Academic Performance", desc: "Semester exam results, rank-holders summary, and failure rate statement." },
    { label: "Growth Metrics", id: "GROWTH_METRICS", name: "Institution Growth & Revenue Trends", desc: "Total revenue generated, admission stats compared to previous 3 academic years." }
  ];
  ...
  return (
    <div className="space-y-6 pb-20 animate-in fade-in duration-700">
      ...
      <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-sm flex items-center gap-6 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-teal-50 rounded-full -mr-32 -mt-32 blur-3xl" />
        <div className="w-16 h-16 rounded-2xl bg-teal-50 flex items-center justify-center text-teal-500 relative z-10 shrink-0">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest mt-1">
            Download Institution Level Statements & Roster Trends
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl p-6 shadow-sm border border-slate-100 space-y-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-bold text-slate-800 text-sm">Select Statement Type</h3>
          </div>
        ...
        <div className="lg:col-span-4 bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="font-bold text-slate-800 text-sm">Report Specifications</h3>
            </div>
            ...
            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100 space-y-4">
              ...
              <div>
                ...
                <span className="text-xs font-bold text-slate-500 mt-0.5 block">Portable Document Format (.pdf)</span>
              </div>

              <div>
                <span className="block text-[8px] font-black text-slate-400 uppercase tracking-widest">Generated On</span>
                <span className="text-xs font-bold text-slate-500 mt-0.5 block">{new Date().toLocaleDateString()}</span>
              </div>
            </div>
          </div>
